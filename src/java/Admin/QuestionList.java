    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<!DOCTYPE html>"
                    ...
                    + "    </div><hr>"
                    + "    </header>");
            out.println("<center><h1>Question List</h1>"
                    + "<div style='width:1200px;height:500px;border:2px solid blue;background-color:lightgrey;overflow:scroll'>"
                    + "<table width=1200px border=1 cellspacing=0 cellpadding=5>"
                    + "<tr bgcolor=cyan>"
                    + "<th>Question id</th> "
                    + "<th>Question</th> "
                    + "<th>Option1</th> "
